...
l_img = cv2.imread('C:/Users/laxma/Desktop/SIH_PROJECT/Website/server/images/image1.jpg')
...
m = cv2.imread('C:/Users/laxma/Desktop/SIH_PROJECT/Website/server/images/download.png')
